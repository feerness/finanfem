        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="recursosDropdown">
              <Link className="dropdown-item" to="./articulosAdmin">
                Artículos
              </Link>
              <Link className="dropdown-item" to="./pdfAdmin">
                PDF's
              </Link>
              <Link className="dropdown-item" to="./videosAdmin">
                Videos
              </Link>
            </div>
          </li>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="comunidadDropdown">
              <Link className="dropdown-item" to="./foroAdmin">
                Foro
              </Link>
              <Link className="dropdown-item" to="./perfilesAdmin">
                Perfiles
              </Link>
            </div>
          </li>
