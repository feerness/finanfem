...
const PdfAdmin = () => {
  ...
  const handleAdd = () => {
    ...
    if (newTitle && newDescription && newLink) {
      setPdfs([...pdfs, { title: newTitle, image: 'images/default.png', description: newDescription, link: newLink }]);
    }
  };
    ...
    <section className="content py-5">
      <div className="container">
        ...
        <div className="add-article">
          <button className="add-task-button" onClick={handleAdd}>Añadir e-book</button>
        </div>
